...
entry:
  ...
  %10 = load i64, i64* %"$foo"
  %11 = add i64 %10, 8
  %12 = bitcast i64* %"struct Foo.l" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %12)
  %probe_read1 = call i64 inttoptr (i64 4 to i64 (i64*, i32, i64)*)(i64* %"struct Foo.l", i32 8, i64 %11)
  %13 = load i64, i64* %"struct Foo.l"
  %14 = bitcast i64* %"struct Foo.l" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %14)
  %15 = getelementptr %printf_t, %printf_t* %printf_args, i32 0, i32 2
  store i64 %13, i64* %15
  ...
  %16 = bitcast %printf_t* %printf_args to i8*
