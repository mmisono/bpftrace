...
entry:
  ...
  store i64 %length.select, i8* %4
  %5 = getelementptr %buffer_64_t, %buffer_64_t* %buffer, i32 0, i32 1
  ...
  %arg0 = load volatile i64, i64* %8
  %probe_read = call i64 inttoptr (i64 4 to i64 ([64 x i8]*, i32, i64)*)([64 x i8]* %5, i64 %length.select, i64 %arg0)
  ...
  %11 = bitcast %buffer_64_t* %buffer to i8*
